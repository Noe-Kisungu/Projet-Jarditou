...
// $pdo = connexionBase(); // Appel de la fonction de connexion : connexion_bdd.php*/
...
/*if (strlen($row->pro_id) <= 4)
{
    $image_src = $row->pro_id.".".$row->pro_id;
} else {
    $image_src = $row->pro_id;
}*/
...
<a href="produits_ajout.php?pro_id=<?= $produit->pro_id?>" class="btn btn-primary m-0">Ajouter</a>
<a href="monpanier.php" class="btn btn-warning m-0">Mon panier</a>
    <!-- FOOTER -->
