...
$pdoStat = $pdo->prepare("UPDATE produits SET pro_ref=:pro_ref, pro_cat_id=:pro_cat_id, pro_libelle=:pro_libelle, pro_description=:pro_description, 
pro_prix=:pro_prix, pro_stock=:pro_stock, pro_couleur=:pro_couleur, pro_bloque=:pro_bloque, pro_d_modif='".$date."', pro_id=:pro_id WHERE pro_id=:pro_id");
...
$pdoStat->bindValue(':pro_id', $nouveauNom, PDO::PARAM_STR);
...
$cheminEtNomDefinitif = 'C:/wamp64/www/jarditou_php/images/jarditou_photos/'.$nouveauNom;
