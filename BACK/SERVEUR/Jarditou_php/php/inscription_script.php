...
$pdoStat = $pdo ->prepare("INSERT INTO users(nom, prenom, mail, identifiant, mdp, date_inscription, acces)
VALUES(:nom, :prenom, :mail, :identifiant, :mdp, '".$date."', :acces)");
...
$pdoStat->bindValue(':mdp', $passwordHash, PDO::PARAM_STR);
