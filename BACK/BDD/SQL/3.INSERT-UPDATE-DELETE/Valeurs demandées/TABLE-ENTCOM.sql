USE DATABASE papyrus;/* selectioner une base de donné */

INSERT INTO `entcom` (`numcom`, `obscom`, `datcom`, `numfou`)/*Insérer les valeurs suivantes dans les colonnes de la table indiquée*/
VALUES (70010, '', '2018-04-23 13:59:51', 120),
