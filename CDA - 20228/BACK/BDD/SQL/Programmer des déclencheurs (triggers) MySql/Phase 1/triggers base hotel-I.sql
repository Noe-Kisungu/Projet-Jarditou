...
SIGNAL SQLSTATE '40000' SET MESSAGE_TEXT = 'Vous avez dépassé le nombre autorisé (10) d''ajout de réservations';
END IF;
END |
...
THEN
SIGNAL SQLSTATE '40000' SET MESSAGE_TEXT = "Votre demande ne peut aboutir car les capacités des chambres pour l'hôtel ont atteint le maximum (50)";
END IF;
END |
DELIMITER ;
